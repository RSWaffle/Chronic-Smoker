...
import com.rswaffle.chronicsmoker.objects.blocks.machine.rollingmachine.BlockRollingMachine;
...
public class BlockInit
{
	...
	public static final Block ROLLING_MACHINE = new BlockRollingMachine("rolling_machine"); 
}
