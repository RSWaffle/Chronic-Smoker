...
public class ContainerRollingMachine extends Container
{
	...
	public ContainerRollingMachine(InventoryPlayer player, TileEntityRollingMachine tileentity) 
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(!RollingMachineRecipes.getInstance().getRollingMachineResult(stack1, slot1.getStack()).isEmpty())
				{
					if(!this.mergeItemStack(stack1, 0, 2, false)) 
					{
						return ItemStack.EMPTY;
					}
					else if(TileEntityRollingMachine.isItemFuel(stack1))
					{
