...
public class ItemTobaccoSeed extends Item implements IHasModel, IPlantable
{
	public ItemTobaccoSeed(String name) 
	{
									  ...
									  float hitZ) 
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.PLANT_TOBACCO.getDefaultState());
			stack.shrink(1);
	...
	{
		return BlockInit.PLANT_TOBACCO.getDefaultState();
	}
